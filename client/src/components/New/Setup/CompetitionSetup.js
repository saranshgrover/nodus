...
export default function CompetitionSetup({ StartComponent }) {
    ...
    const steps = [...(step0 ? ['Import Data'] : []), 'Info', 'Competitors', 'Events', 'Schedule', 'Groups', 'Settings']
    const getStepComponent = () => {
        ...
        switch (step) {
            ...
            case 5:
                return <SettingsSetup id={id} onComplete={handleComplete} handleBack={handleBack} />
            default:
                return <Error />
        }
    }
