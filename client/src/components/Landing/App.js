...
import { getMyManagableComps, getMyUpcomingComps } from '../../logic/wca-api'
import { isSignedIn, signOut } from '../../logic/auth'
import history from '../../logic/history'
import { sortArrayByDate } from '../../logic/tools'
								...
								<Route
									...
									render={(props) => (
										<LandingSignedIn
											...
											userInfo={userInfo}
											myUpcomingComps={
												this.state.upcomingComps
											}
										/>
									)}
								/>
								<Route path='/new' component={NewCompetition} />
								<Route
									path='/project/:compId'
									component={Projector}
								/>
